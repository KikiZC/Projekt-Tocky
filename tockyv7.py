...
points = [
    {"position": pos, "distance": 0, "color": p_color, "angular_speed": 0, "start_angle": 0},
    {"position": pos, "distance": 200, "color": p_color, "angular_speed": 210, "parent_index": 0, "start_angle": 0},
    {"position": pos, "distance": 100, "color": p_color, "angular_speed": -100, "parent_index": 1, "start_angle": 0},
    {"position": pos, "distance": 100, "color": p_color, "angular_speed": -200, "parent_index": 1, "start_angle": 0},
    {"position": pos, "distance": 100, "color": p_color, "angular_speed": 150*, "parent_index": 1, "start_angle": 0},
]
...
def update_button_color(name, text):
    for button in buttons:
        if button["jmeno"] == name:
            button["color"] = text
            break
